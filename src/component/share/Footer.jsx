...
const Footer = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 h-0 right-0">
      <div className="bg-gradient-to-t to-slate-800 from-slate-950">
        <div className="footer justify-around pt-24 text-white">
          <nav>
        ...
        <p className="text-center pt-12 pb-6 text-sm text-slate-400">
          @ All copy right reserved by Fashion
        </p>
      </div>
    </div>
  );
