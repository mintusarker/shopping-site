...
const Service = () => {
  return (
    <div className="lg:flex md:flex sm:flex flex-warp justify-center items-center mx-auto w-full border-t-2 border-slate-400 pt-28 pb-28 lg:px-12 md:px-4 sm:px-2">
